...
TOOLS: list[dict] = [
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                "room": {
                    "type": "string",
                    "description": "small/bedroom/one  OR  big/livingroom/two",
                }
            },
            "required": ["room"],
        },
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "delta_f": {
                    "type": "number",
                    "description": "Degrees °F to add (e.g. +2 or -2)",
                },
            },
    ...
    },
    {
        ...
        "description": (
            "Set thermostat target to the current room temperature "
            "(effectively pauses cooling/heating)."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": (
            "Adjust thermostat set-point so the fan turns ON "
            "(lowers target below current temp)."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": (
            "Adjust thermostat set-point so the fan turns OFF "
            "(raises target above current temp)."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
